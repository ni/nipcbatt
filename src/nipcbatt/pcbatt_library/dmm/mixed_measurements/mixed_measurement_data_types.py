...
class MixedMeasurementConfiguration(PCBATestToolkitData):
    """Defines configuration parameters for mixed DC-RMS measurements."""
    ...
    def measurement_function_parameters(self) -> MixedMeasurementFunctionParameters:
        ...
        Returns:
            MixedMeasurementFunctionParameters: The voltage range, function,
...
class MixedMeasurementResultData(PCBATestToolkitData):
    """Defines mixed DC-RMS results obtained from DMM DC-RMS Mixed Measurement."""
