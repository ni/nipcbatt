...
class MeasurementExecutionType(Enum):
    """Defines the execution type for DC constant current source and measure."""
...
class ExecutionSettings:
    """Defines execution settings for a DC constant current source and measure operation."""
...
class TimingParameters:
    """Defines timing settings for DC constant current source and measure."""
