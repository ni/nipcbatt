...
class AudioFilterTest:  
    ...
    def initialize_multi_tone_audio_signal_gen( 
        ...
        self.signal_voltage_gen_task = nipcbatt.pcbatt_library.daq.SignalVoltageGeneration()
        self.signal_voltage_gen_task.initialize("TS_LINE_IN0")

    def initialize_audio_meas(  
        self,
    ) -> None:
        self.freq_domain_meas_task = nipcbatt.pcbatt_library.daq.FrequencyDomainMeasurement()
    ...
    def configure_audio_meas( 
        ...
        configuration = nipcbatt.pcbatt_library.daq.FrequencyDomainMeasurementConfiguration(
    ...
    def send_multi_tone_audio_signal(  
        ...
        configuration = nipcbatt.pcbatt_library.daq.SignalVoltageGenerationMultipleTonesConfiguration(
