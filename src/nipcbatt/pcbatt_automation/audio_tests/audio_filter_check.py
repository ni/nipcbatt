...
def setup():
    ...
    generation_instance = nipcbatt.pcbatt_library.daq.SignalVoltageGeneration()
    measurement_instance = nipcbatt.pcbatt_library.daq.FrequencyDomainMeasurement()
...
def main(
    ...
    meas_config_configure_only = nipcbatt.pcbatt_library.daq.FrequencyDomainMeasurementConfiguration(
    ...
    tone_params0 = nipcbatt.pcbatt_library.daq.ToneParameters(
        tone_frequency_hertz=10.0, tone_amplitude_volts=1.0, tone_phase_radians=0.0
    )

    tone_params1 = nipcbatt.pcbatt_library.daq.ToneParameters(
        tone_frequency_hertz=100.0, tone_amplitude_volts=1.0, tone_phase_radians=0.0
    )

    tone_params2 = nipcbatt.pcbatt_library.daq.ToneParameters(
        tone_frequency_hertz=1000.0, tone_amplitude_volts=1.0, tone_phase_radians=0.0
    )

    tone_params3 = nipcbatt.pcbatt_library.daq.ToneParameters(
        tone_frequency_hertz=10000.0, tone_amplitude_volts=1.0, tone_phase_radians=0.0
    )

    multi_tone_params = nipcbatt.pcbatt_library.daq.SignalVoltageGenerationMultipleTonesWaveParameters(
    ...
    gen_timing_params = nipcbatt.pcbatt_library.daq.SignalVoltageGenerationTimingParameters(
        sample_clock_source="OnboardClock",
        sampling_rate_hertz=100000,
    ...
    gen_config = nipcbatt.pcbatt_library.daq.SignalVoltageGenerationMultipleTonesConfiguration(
    ...
    meas_config_postgen = nipcbatt.pcbatt_library.daq.FrequencyDomainMeasurementConfiguration(
        global_channel_parameters=glob_chan_params,
        specific_channels_parameters=spec_chan_params,
