...
def setup(
    ...
    button_instance = nipcbatt.pcbatt_library.daq.DcVoltageGeneration()
    dc_rms_voltage_test_point = nipcbatt.pcbatt_library.daq.DcRmsVoltageMeasurement()
...
def main(
    ...
    button_configuration = nipcbatt.pcbatt_library.daq.DcVoltageGenerationConfiguration(
        voltage_generation_range_parameters=nipcbatt.pcbatt_library.daq.DEFAULT_VOLTAGE_GENERATION_CHANNEL_PARAMETERS,
    ...
    test_point_result_data_after_button_on = dc_rms_voltage_test_point.configure_and_measure(
        configuration=nipcbatt.pcbatt_library.daq.DEFAULT_DC_RMS_VOLTAGE_MEASUREMENT_CONFIGURATION,
    )
