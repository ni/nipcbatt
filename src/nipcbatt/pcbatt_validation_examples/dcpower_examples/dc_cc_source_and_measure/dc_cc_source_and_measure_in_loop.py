...
def main():
    ...
    configure_only = dcpower.DCCurrentSourceAndMeasureParameters(
    ...
    start_source_only = dcpower.DCCurrentSourceAndMeasureParameters(
        current_channel_settings=current_channel_settings,
        execution_settings=dcpower.ExecutionSettings(
    ...
    measure_only = dcpower.DCCurrentSourceAndMeasureParameters(
        current_channel_settings=current_channel_settings,
        execution_settings=dcpower.ExecutionSettings(
    ...
    # ======================= Configure only ============================
    dc_current_source_and_measure.configure_and_measure(configuration=configure_only)

    # ======================= Start source only =========================
    dc_current_source_and_measure.configure_and_measure(configuration=start_source_only)

    # ======================= Measure only in loop ======================
    num_iterations = 5
    for iteration in range(num_iterations):
        results = dc_current_source_and_measure.configure_and_measure(configuration=measure_only)
